...
public class MealActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (steps.length == 0) {
            ((Chronometer) findViewById(R.id.MealActivityTimer)).setVisibility(View.GONE);
            Toast.makeText(getApplicationContext(), "Keine Schritte konfiguriert", Toast.LENGTH_LONG);
            return;
        }
        stepId = 0;
        loadStep();
